 ...
 */
const expReplaceRE = /__DOCUE_EXP_START__(.*?)__DOCUE_EXP_END__/g
 ...
 * `@docue/runtime-dom` will create the content via innerHTML in a hidden
    ...
    if (p.type === NodeTypes.ATTRIBUTE) {
      ...
      if (p.name === 'bind') {
        ...
        if (exp.content[0] === '_') {
          ...
          }="__DOCUE_EXP_START__${exp.content}__DOCUE_EXP_END__"`
          continue
        }
        // #6568
        if (
