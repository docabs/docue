...
describe('transition-group', () => {
  test('basic', () => {
    expect(
      ...
      "const { ssrRenderList: _ssrRenderList } = require(\\"docue/server-renderer\\")
  ...
  test('with static tag', () => {
    expect(
      ...
      "const { ssrRenderAttrs: _ssrRenderAttrs, ssrRenderList: _ssrRenderList } = require(\\"docue/server-renderer\\")
