...
describe('defineCustomElement', () => {
  ...
  describe('mounting/unmount', () => {
    ...
    test('should work', () => {
      ...
      const e = container.childNodes[0] as DocueElement
    ...
    test('should not unmount on move', async () => {
      ...
      const e = container.childNodes[0].childNodes[0] as DocueElement
      const i = e._instance
  ...
  describe('emits', () => {
    ...
    test('case transform for camelCase event', () => {
      ...
      // using the custom element in a Docue template
  ...
  describe('provide/inject', () => {
    ...
    test('over nested usage', async () => {
      ...
      const provider = container.childNodes[0] as DocueElement
      const consumer = provider.shadowRoot!.childNodes[0] as DocueElement
    ...
    test('over slot composition', async () => {
      ...
      const consumer = provider.childNodes[0] as DocueElement
      expect(consumer.shadowRoot!.innerHTML).toBe(`<div>injected!</div>`)
    ...
    test('inherited from ancestors', async () => {
      ...
      const providerA = container.childNodes[0] as DocueElement
      const providerB = providerA.shadowRoot!.childNodes[0] as DocueElement
      const consumer = providerB.shadowRoot!.childNodes[0] as DocueElement
  ...
  describe('styles', () => {
    test('should attach styles to shadow dom', () => {
      ...
      const el = container.childNodes[0] as DocueElement
  ...
  describe('async', () => {
    test('should work', async () => {
      ...
      const e1 = container.childNodes[0] as DocueElement
      const e2 = container.childNodes[1] as DocueElement
