...
describe('api: createApp', () => {
  ...
  test('provide', () => {
    ...
    expect('[Docue warn]: injection "__proto__" not found.').toHaveBeenWarned()
  ...
  test('return property "_" should not overwrite "ctx._", __isScriptSetup: false', () => {
    ...
    expect(
      `setup() return property "_" should not start with "$" or "_" which are reserved prefixes for Docue internals.`
    ).toHaveBeenWarned()
  })
  ...
  // config.compilerOptions is tested in packages/Docue since it is only
