...
import * as runtimeTest from '@docue/runtime-test'
import { registerRuntimeCompiler, createApp } from '@docue/runtime-test'
import { baseCompile } from '@docue/compiler-core'

declare var __DOCUE_HMR_RUNTIME__: HMRRuntime
const { createRecord, rerender, reload } = __DOCUE_HMR_RUNTIME__

registerRuntimeCompiler(compileToFunction)

function compileToFunction(template: string) {
  const { code } = baseCompile(template)
  const render = new Function('Docue', code)(
    runtimeTest
