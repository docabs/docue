...
describe('compiler sfc: rewriteDefault', () => {
  ...
  test(`export { default } from '...'`, async () => {
    expect(
      ...
      "import { default as __DOCUE_DEFAULT__ } from './index.js'
      export {  foo } from './index.js'
      const script = __DOCUE_DEFAULT__"
    `)
    ...
    expect(
      ...
      "import { foo as __DOCUE_DEFAULT__ } from './index.js'
    ...
    expect(
      ...
      "import { a as __DOCUE_DEFAULT__ } from 'xxx'
      const a = 1 
      export {  } from 'xxx'
      const script = __DOCUE_DEFAULT__"
    `)
