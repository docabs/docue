...
const deprecationData: Record<CompilerDeprecationTypes, DeprecationData> = {
  [CompilerDeprecationTypes.COMPILER_IS_ON_ELEMENT]: {
    message:
      ...
      `treated as components in Docue 3 unless the "is" value is explicitly ` +
      `prefixed with "docue:".`,
  ...
  [CompilerDeprecationTypes.COMPILER_V_BIND_PROP]: {
    message:
      ...
      `Docue 3 will automatically set a binding as DOM property when appropriate.`
  },
  ...
  [CompilerDeprecationTypes.COMPILER_V_IF_V_FOR_PRECEDENCE]: {
    message:
      ...
      `in Docue 3: v-if now takes higher precedence and will no longer have ` +
  ...
  [CompilerDeprecationTypes.COMPILER_NATIVE_TEMPLATE]: {
    message:
      ...
      `element instead of its inner content in Docue 3.`
  },

  [CompilerDeprecationTypes.COMPILER_INLINE_TEMPLATE]: {
    message: `"inline-template" has been removed in Docue 3.`,
