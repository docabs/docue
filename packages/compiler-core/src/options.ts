...
export interface CodegenOptions extends SharedTransformCodegenOptions {
   ...
   * - `function` mode will generate a single `const { helpers... } = Docue`
   * statement and return the render function. It expects `Docue` to be globally
